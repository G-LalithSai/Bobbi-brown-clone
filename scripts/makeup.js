let a="May Beauty Event:30% off Vitamin Enriched Eye Base And 40% off selcect grow."
let b="Get 15% off Your first order plus free shiping everyday when you join BB Access."
let arr=[a,b]
let i=0;
